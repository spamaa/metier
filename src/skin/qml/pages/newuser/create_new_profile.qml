...
Page {
    ...
    */
    ...
    Timer {
        ...
        running: false
        onTriggered: {
            otwrap.createNym(pageRoot.profileNym);
            ...
            /*
            if (typeof rootAppPage !== "undefined") {
                rootAppPage.clearStackHome("pages/existing_user/single_crypto_account_display.qml")
            }
            */
            // Should call slot to trigger signal propagation threw the main.qml Nav stack.
            // But main window, which is listening to otwrap signals will should do this.
