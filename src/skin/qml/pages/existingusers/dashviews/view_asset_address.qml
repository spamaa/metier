...
Page {
  ...
  property bool is_changing: false         // animating the swaping of address type
  ...
  Timer {
    ...
    onTriggered: {
      ...
      assetQRcodeImage.set_display_string(dashViewRoot.userPaymentCode)
      dashViewRoot.is_changing = false
    }
  }
