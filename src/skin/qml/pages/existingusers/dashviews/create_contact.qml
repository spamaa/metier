...
Page {
  ...
  function createNewContact() {
    // TODO: need text field for contact's name, unless grabbing value from blockchain.
    ...
    // TODO: find a way if possible to validate address with out an AccountActivity model.
    var addressValid = true // AccountActivity_model.validateAddress(addressInputText.text)
    ...
    if (addressValid) {
      ...
      console.log("New Contact address is not valid.", addressInputText.text)
    }
  }
