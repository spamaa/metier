...
Page {
  ...
  property bool show_testnet_chains: true // Default blockchain live/test state.
  function populateBlockChains(istest_chains = true) {
      ...
      Rectangle {
        ...
        Rectangle {
          ...
          Row {
            ...
            // TODO: get blockchain name from AssetList model indexes for
            // blockchain icon display. (it's notary)
            ...
            Rectangle {
              ...
              visible: (tabDisplayBeltButtonGroup.managementMode === 0)
              border.color: (model.enabled ? DawgsStyle.aa_selected_ol : DawgsStyle.aa_norm_ol)
              border.width: 1
              anchors.verticalCenter: parent.verticalCenter
              // switch marker
