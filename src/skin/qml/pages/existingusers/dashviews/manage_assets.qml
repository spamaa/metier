  ...
  Column {
    ...
    Component {
      ...
      Rectangle {
        ...
        //TODO: disable BSV 'OG Bitcoin' untill further testing is done.
        visible: (model.type !== 1) // disable BSV
            ...
            Rectangle {
              ...
              MouseArea {
                ...
                onClicked: {
                  ...
                  //TODO: disable BSV 'OG Bitcoin' untill further testing is done.
                  if (model.type === 1) {
                    console.log("Managing an asset that is disabled.", model.type, model.name)
                    return
                  }
