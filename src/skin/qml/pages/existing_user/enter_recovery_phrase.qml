...
Page {
    ...
    // otwrap.wordCount(const int type, const int strength)
    property var requiredWordCount: 12 //this is temp, it is set via combo_box
    property var longestWord: 8 //otwrap.longestSeedWord <- can not be notifi-able, is updated at later time
    ...
    function onFinishButton() {
        ...
        // pass Recover data collection to otwrap to see if 
        ...
        // otwrap.importSeed(1, 1, passingWords, ""); // BIP39, English <- basic importing concept
        ...
        //otwrap.importSeed(seedtype_int, seedlang_int, passingWords, passPhraseTextInput.text)
        //otwrap.checkStartupConditions() // importSeed should be calling this when finished
    }
    ...
    function recalibrateVectors() {
        ...
        pageRoot.longestWord = otwrap.longestSeedWord
    ...
    Rectangle {
        ...
        Timer {
            ...
            onTriggered: {
                ...
                otwrap.importSeed(seedtype_int, seedlang_int, 
        ...
        Rectangle {
            ...
            Row {
                ...
                MatterFi_SeedLangComboBox {
                    ...
                    model: otwrap.seedLanguageModelQML(encryption_CB.currentIndex + 1)
                ...
                MatterFi_SeedSizeComboBox {
                    ...
                    model: otwrap.seedSizeModelQML(encryption_CB.currentIndex + 1)
