...
Page {
    ...
    property var accountListModel_OT: otwrap.accountListModelQML()
    //-----------------------------------------------------------------------------
    // Create connections:
    Component.onCompleted: {
        // display block sync notification
        //var accountList_model = otwrap.accountListModelQML()
        accountListModelDelegator.model = otwrap.accountListModelQML()
    ...
    function onAction_accountList(selection) {
        ...
        var activityModel = otwrap.accountActivityModelQML(selection.account)
    ...
    Row {
        ...
        Rectangle {
            ...
            DelegateModel {
                ...
                model: [] // this gets set via: otwrap.accountListModelQML()
