...
Page {
  ...
  function populateBlockChains() {
    pageRoot.testBlockChainList = otwrap.blockchainChooserModelQML(test) // test blockchains
  ...
  Component.onCompleted: {
    ...
    otwrap.chainsChanged.connect(pageRoot.blockChainChanged)
    // make the chain selection list
    pageRoot.populateBlockChains()
  }

  Component.onDestruction: {
    otwrap.chainsChanged.disconnect(pageRoot.blockChainChanged)
  }
