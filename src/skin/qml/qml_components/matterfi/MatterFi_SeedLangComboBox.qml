...
ComboBox {
  ...
  indicator: Canvas {
    ...
    onPaint: {
      ...
      ctx.closePath();
      ctx.fillStyle = contextRoot.pressed ? DawgsStyle.buta_active : DawgsStyle.buta_selected
      ctx.fill();
    }
  }
  ...
  contentItem: Text {
    ...
    font: contextRoot.font
    color: contextRoot.pressed ? DawgsStyle.buta_active : DawgsStyle.buta_selected
    verticalAlignment: Text.AlignVCenter
    elide: Text.ElideRight
  }
  ...
  background: Rectangle {
    implicitWidth: 120
    implicitHeight: 40
    border.color: contextRoot.pressed ? DawgsStyle.buta_active : DawgsStyle.buta_selected
  ...
  popup: Popup {
    ...
    // BG fill
    background: Rectangle {
      border.color: DawgsStyle.buta_selected
      radius: 2
    }
    // close
    onClosed: {
