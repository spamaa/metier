  ...
  Rectangle {
    ...
    Component {
      ...
      Dashboard_ListDetailedDeligate {
        ...
        property var timeElapsed: DawgsStyle.getElapsedTime(modelData.timestamp)
        toplText: "" //modelData.description
        ...
        Component.onCompleted: {
          var first_space = modelData.description.indexOf(' ')
          listDeligate.toplText = modelData.description.substr(0, first_space)
        }
      }
    }
