    ...
    if (assetContextRoot.accountID === "") {
      ...
      var loop_index = 0
        ...
        if (asset_indexmodel.lmodel.account !== assetContextRoot.accountID) {
          ...
          dashViewRoot.useContractID = asset_indexmodel.lmodel.contractid
          //debugger:
    ...
    Component {
      ...
      Rectangle {
        ...
        MatterFi_BlockChainIcon {
          ...
          x: 12
          abvNotary: (model.unitname !== null ? model.unitname : "")
          anchors.verticalCenter: parent.verticalCenter
          // ensure the unitname role property is ready
          Timer {
            running: true
            interval: 300
            repeat: false
            onTriggered: {
              assetListBlockChainIcon.abvNotary = (model.unitname !== null ? model.unitname : "")
              assetListBlockChainIcon.setIconFile()
            }
          }          
        }
