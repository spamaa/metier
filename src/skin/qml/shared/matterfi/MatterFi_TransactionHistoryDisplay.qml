...
Rectangle {
  ...
  function getDisplayColumnRowData(for_index) {
    ...
    if (accountActivityModel !== undefined) {
      ...
      // debugger:
      //console.log("Set display deligate data for:", for_index)
  ...
  //-----------------------------------------------------------------------------
  // What each entry in the list looks like when Deligated from OT AccountActivity
  DelegateModel {
    ...
    delegate: Column {
      ...
      Component.onCompleted: {
        ...
        rowModelDelegate.display_data = widget.getDisplayColumnRowData(index)
        // debugger:
        ...
        Column {
          ...
          Row {
            ...
            MatterFi_Button_Accent {
              ...
              onClicked: {
                var web_url = widget.pktExplorerBaseURL + "/" + display_data['uuid']
                otwrap.openSystemBrowserLink(web_url)
              }
            }
          }
          //----------------------
