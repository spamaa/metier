...
Item {
	...
	Component.onDestruction: {
		if (contactActivity_model !== undefined && widget.contactActivity_model.dataChanged !== undefined) {
			widget.contactActivity_model.dataChanged.disconnect(activityUpdated)
		}
	}
				...
				Column {
					...
					Rectangle {
						...
						TextInput {
							...
							//onTextEdited: {
								//debugger:
								//console.log("Message box input changed.", widget.contactActivity_model.canMessage)
							//}
							...
							onAccepted: {
								if (widget.contactActivity_model.canMessage === true) {
									widget.sendDraft()
								}
							}
						}
					...
					Row {
						...
						FontIconButton {
							...
							enabled: (widget.contactActivity_model === undefined ? 
								false : widget.contactActivity_model.canMessage === true
							);
