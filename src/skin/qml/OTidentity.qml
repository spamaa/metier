...
QtObject {
  ...
  function changeActiveNym(to_mattercode_id) {
    //debugger:
    console.log("OTidentity wants to swap nym identity:", to_mattercode_id)
    identityRootContext.clearFocusedModels()
  ...
  // Clears all model pointers for OT.
  function clearFocusedModels() {
    identityRootContext.profile_OTModel = undefined
    identityRootContext.contactList_OTModel = undefined
    identityRootContext.contactActivityThread_OTModel = undefined
    identityRootContext.accountList_OTModel = undefined
    identityRootContext.accountList_OTModel = undefined
    identityRootContext.focusedAccountStatus_OTModel = undefined
    identityRootContext.focusedAccountActivity_OTModel = undefined
  }
  ...
  //----------------------
  // Grab an account status model by an account id:
  function getAcountStatusModel(account_id) {
    return userIdentity_OTModel.getAccountStatusQML(account_id)
  }
