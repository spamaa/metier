...
QtObject {
  ...
  // Enable QR code camera scanning UI components: TODO auto context detection.
  property bool has_qrCode_scanner: false
	// Enable token searching UI for ablility to add assets to the wallet.
	property bool can_search_tokens: false
  // Enable OT Exchange UI components: TODO bugzilla#34
  property bool ot_exchanges: false
  // Enable debugging Asset list Right click veiw advanced blockchain details.
  property bool advanced_details: true
  //----------------------
  //debugger:
